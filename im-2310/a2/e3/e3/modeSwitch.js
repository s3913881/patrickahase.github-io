...
if(window.matchMedia("(prefers-color-scheme: dark)").matches){
  ...
  document.documentElement.style.setProperty("--col-05", darkCol);
  document.documentElement.style.setProperty("--col-04", lightBor);
  document.documentElement.style.setProperty("--col-03", darkBor);
...
// alert(isDark);
  ...
  if (isDark){
    ...
    document.documentElement.style.setProperty("--col-01", lightCol);
    document.documentElement.style.setProperty("--col-05", darkCol);
    document.documentElement.style.setProperty("--col-03", lightBor);
    document.documentElement.style.setProperty("--col-04", darkBor);
    ...
    document.documentElement.style.setProperty("--col-05", lightCol);
    document.documentElement.style.setProperty("--col-03", darkBor);
    document.documentElement.style.setProperty("--col-04", lightBor);
    document.getElementById("mode-button").innerHTML = "Light Mode";
  }
