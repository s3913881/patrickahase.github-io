...
/*I would like to choose the fullscreen feature as an extra because
   1. Visual aspect: I want to place a function icon on the right side of the progress bar, which is used to make the video controls visually more harmonious 
   and achieve visual balance. The fullscreen icon is usually placed on the far right, so I choose the fullscreen feature.
   2.Functionality: I think the existing features already meet the most basic user needs, while the full-screen feature improves visibility and readability, 
   providing a better viewing experience and larger visual controls. It can be more intuitive to improve the user experience. */
function fullScreen () {
